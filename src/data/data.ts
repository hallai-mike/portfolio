...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      `${process.env.PUBLIC_URL}/project-images/comic-dreamer/2-splash.PNG`,
      `${process.env.PUBLIC_URL}/project-images/comic-dreamer/3-landing.PNG`,
      ...
      `${process.env.PUBLIC_URL}/project-images/comic-dreamer/6-result-1.PNG`,
      `${process.env.PUBLIC_URL}/project-images/comic-dreamer/7-remix-view.PNG`,
      `${process.env.PUBLIC_URL}/project-images/comic-dreamer/8-style-form.PNG`,
      `${process.env.PUBLIC_URL}/project-images/comic-dreamer/9-remix-result.PNG`,
      `${process.env.PUBLIC_URL}/project-images/comic-dreamer/10-library.PNG`,
